...
<head>
  ...
  <link rel="stylesheet" href="dashboard/css/lumen.css">
  <link rel="stylesheet" href="dashboard/css/digital.css">
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.6.3/css/all.css">
  <link rel="stylesheet" href="https://daneden.github.io/animate.css/animate.min.css">
  <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
  <title>Digital Entrepreneurs</title>
...
<body>
  <div class="header">
    <img
      src="https://www.islabit.com/wp-content/uploads/2018/10/Trading.png"
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary header-nav">
      ...
      <div class="collapse navbar-collapse" id="navbarColor02">
        ...
        <form class="form-inline my-2 my-lg-0">
          ...
          <a href="login.php" class="btn btn-secondary my-2 my-sm-0" style="border-radius: 25em;padding-left: 50px;padding-right: 50px;" type="submit">Iniciar Sesion</a>
        </form>
      </div>
    </nav>
    <!--/////////////////////////////////////////| End Navbar |//////////////////////////////////////////////-->
  ...
  <div class="row"  data-aos="fade-up" data-aos-duration="300" data-aos-delay="300">
    ...
    <div class="col-md-3 footer-social animated fadeInDown">
        ...
        <ul>
          ...
          <h4>Email</h4>
          <ul>
              <li><a href="#">contact@simpleksolutions.com</a></li>
              <li><a href="#">simplekeysolutions@simpleksolutions.com</a></li>
